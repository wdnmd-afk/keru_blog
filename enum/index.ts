type TFileType = 'PDF' | 'IMAGE' | 'VIDEO' | 'AUDIO' | 'DOC' | 'EXCEL' | 'POWERPOINT' | 'ARCHIVE' | 'OTHER';
type IFileType ={
...
const FileType:IFileType = {
    ...
    OTHER: ['html', 'css', 'js', 'json', 'xml', 'yaml', 'yml', 'ts', 'tsx', 'jsx', 'vue', 'md', 'markdown', 'txt', 'csv', 'tsv', 'json', 'xml', 'yaml', 'yml', 'sql', 'db', 'mdb', 'sqlite', 'csv', 'tsv', 'json', 'xml', 'yaml', 'yml', 'sql', 'db', 'mdb', 'sqlite', 'csv', 'tsv', 'json'],
}
//需要返回的是Key

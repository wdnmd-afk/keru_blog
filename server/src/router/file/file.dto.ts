...
import { IsFileType, IsFileSizeValid, IsSafeString } from '@/common/validation.decorators'
...
export class FileCheckDto {
    ...
    @IsSafeString({ message: '文件名包含不安全字符' })
    fileName: string
}
...
export class FileChunkDto {
    ...
    @IsFileSizeValid(100, { message: '文件大小不能超过100MB' }) // 100MB 限制

...
import { Alert, Button, Space, Spin, Switch, Tooltip, message } from 'antd'
...
const MarkdownPreview: React.FC<MarkdownPreviewProps> = ({
    ...
    return (
        <div className="markdown-preview-container">
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 border-b">
                    <div className="flex items-center space-x-4">
                        ...
                        {showSourceToggle && (
                            <div className="flex items-center space-x-2">
                                <EyeOutlined
                                    className={!showSource ? 'text-blue-500' : 'text-gray-400'}
                                />
                                <Switch
                                    size="small"
                                    checked={showSource}
            ...
            {/* Markdown预览区域 */}
            <div className="bg-white overflow-auto" style={{ height: maxHeight }}>
                {loading ? (

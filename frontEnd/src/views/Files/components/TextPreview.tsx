...
const TextPreview: React.FC<TextPreviewProps> = ({
    ...
    const loadTextContent = useCallback(
        async (textEncoding: string = selectedEncoding) => {
            try {
                setLoading(true)
                setError(null)
    ...
    return (
        <div className="text-preview-container">
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 border-b">
                    ...
                    <Space size="small">
                        <div className="flex items-center space-x-2">
                            ...
                            <Switch size="small" checked={lineNumbers} onChange={setLineNumbers} />
                        </div>
            ...
            {/* 文本预览区域 */}
            <div className="bg-white border overflow-auto" style={{ height: maxHeight }}>
                {loading ? (
            ...
            {showToolbar && !loading && !error && (
                <div className="flex items-center justify-between p-2 bg-gray-50 border-t text-xs text-gray-500">
                    ...
                    <span>编码: {selectedEncoding.toUpperCase()}</span>
                </div>
            )}
        </div>
    )

...
const UploadTab: React.FC = () => {
    ...
    // 移除强制渲染机制，避免无限循环
    const enhancedUpdateUploadFileStatus = useCallback(
        (uid: string, status: Partial<UploadFileItem>) => {
    ...
    const uploadEvents: UploadEvents = useMemo(
        ...
        [refreshFileList, enhancedUpdateUploadFileStatus]
    ) // 移除uploadFileList依赖
    ...
    const handleFileListChange = (
        newFileListOrUpdater: UploadFileItem[] | ((prev: UploadFileItem[]) => UploadFileItem[])
    ) => {

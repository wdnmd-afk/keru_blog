...
import "./styles.js";
import { createExcludeComparator } from "./utils.js";
...
const KTable = require$$0.forwardRef(
  ({
    showCheck,
    fetchData,
    bordered = false,
    ...
    const handleTableChange = (pagination, filters, sorter, extra) => {
      onChange == null ? void 0 : onChange(pagination, filters, sorter, extra);
    };
...
const MemoizedKTable = require$$0.memo(
  KTable,
  createExcludeComparator(["fetchData", "onChange", "rowClick"], false)
);
MemoizedKTable.displayName = "KTable";
export {
  MemoizedKTable as KTable
};
